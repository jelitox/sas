...
<table width="686" height="25" border="0" cellpadding="1" cellspacing="1">
  ...
  <table  width="686" border="0">
      <tr>
      <td width="235">&nbsp;</td>
      <td width="90"><input name="nuevo" type="button" id="nuevo" value="  Nuevo" class='btn_act btn_nuevo_act_img' onclick="limpiar_form(this.form)" title="Pulse para activar campos"/></td>
